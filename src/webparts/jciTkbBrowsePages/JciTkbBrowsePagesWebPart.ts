...
import * as strings from "JciTkbBrowsePagesWebPartStrings";
import JciTkbBrowsePages from "./components/JciTkbBrowsePages";
import { IJciTkbBrowsePagesProps } from "./components/IJciTkbBrowsePagesProps";
import { SPHttpClient, SPHttpClientResponse } from "@microsoft/sp-http";

export interface IJciTkbBrowsePagesWebPartProps {
  selectedView: string;
...
export default class JciTkbBrowsePagesWebPart extends BaseClientSideWebPart<IJciTkbBrowsePagesWebPartProps> {
  private viewOptions: IView[] = [];

  public render(): void {
    const element: React.ReactElement<IJciTkbBrowsePagesProps> =
      React.createElement(JciTkbBrowsePages, {
